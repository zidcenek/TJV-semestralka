...
/**
 * Jersey REST client generated for REST resource:AnimalFacadeREST [animal]<br>
 * USAGE:
 * <pre>
...
public class AnimalClient {
    ...
    public <T> T findSearchedAnimals_XML(Class<T> responseType, String searched) throws ClientErrorException {
    ...
    public <T> T findSearchedAnimals_JSON(Class<T> responseType, String searched) throws ClientErrorException {
        if (searched == null || "".equals(searched.trim())) {
